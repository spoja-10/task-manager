...
export default function Register() {
  ...
  useEffect(() => {
    if (window.google && import.meta.env.VITE_GOOGLE_CLIENT_ID !== 'placeholder') {
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="font-sans font-800 text-3xl text-ink-900 dark:text-ink-100 tracking-tight">
              TaskFlow
            </span>
          </div>
          <p className="text-ink-500 dark:text-ink-400 font-mono text-sm">
            Create your account
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-ink-900 rounded-2xl border border-ink-100 dark:border-ink-800 p-8 shadow-sm">
          ...
          <div id="google-btn" className="flex justify-center">
            <div className="w-full py-2.5 border border-ink-200 dark:border-ink-700 rounded-xl text-center text-sm text-ink-500 dark:text-ink-400 font-mono">
              Google Sign-Up (add VITE_GOOGLE_CLIENT_ID to enable)
            </div>
          </div>
          ...
          <p className="mt-2 text-center text-sm">
            <Link
              to="/"
              className="text-ink-400 hover:text-ink-600 dark:hover:text-ink-300 text-xs font-mono underline underline-offset-2"
            >
              Continue as guest →
            </Link>
          </p>
